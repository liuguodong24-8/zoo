...
type Data struct {
	...
	Eth      *Data_Eth      `protobuf:"bytes,3,opt,name=eth,proto3" json:"eth,omitempty"`
}
...
type Data_Eth struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	EthAddr      string `protobuf:"bytes,1,opt,name=eth_addr,json=ethAddr,proto3" json:"eth_addr,omitempty"`
	ZooAddr      string `protobuf:"bytes,2,opt,name=zoo_addr,json=zooAddr,proto3" json:"zoo_addr,omitempty"`
	ZooTokenAddr string `protobuf:"bytes,3,opt,name=zoo_token_addr,json=zooTokenAddr,proto3" json:"zoo_token_addr,omitempty"`
	ZooNftAddr   string `protobuf:"bytes,4,opt,name=zoo_nft_addr,json=zooNftAddr,proto3" json:"zoo_nft_addr,omitempty"`
	ZooPrivate   string `protobuf:"bytes,5,opt,name=zoo_private,json=zooPrivate,proto3" json:"zoo_private,omitempty"`
}

func (x *Data_Eth) Reset() {
	*x = Data_Eth{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_Eth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Eth) ProtoMessage() {}

func (x *Data_Eth) ProtoReflect() protoreflect.Message {
	mi := &file_conf_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Eth.ProtoReflect.Descriptor instead.
func (*Data_Eth) Descriptor() ([]byte, []int) {
	return file_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_Eth) GetEthAddr() string {
	if x != nil {
		return x.EthAddr
	}
	return ""
...
func (x *Data_Eth) GetZooAddr() string {
	if x != nil {
		return x.ZooAddr
	}
	return ""
...
func (x *Data_Eth) GetZooTokenAddr() string {
	if x != nil {
		return x.ZooTokenAddr
	}
	return ""
}

func (x *Data_Eth) GetZooNftAddr() string {
	if x != nil {
		return x.ZooNftAddr
	}
	return ""
...
func (x *Data_Eth) GetZooPrivate() string {
	if x != nil {
		return x.ZooPrivate
	}
	return ""
...
var file_conf_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x22, 0xac, 0x04, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64,
	...
	0x12, 0x26, 0x0a, 0x03, 0x65, 0x74, 0x68, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e,
	0x45, 0x74, 0x68, 0x52, 0x03, 0x65, 0x74, 0x68, 0x1a, 0x3a, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61,
	...
	,
}
...
var file_conf_proto_goTypes = []interface{}{
	...
	(*Data_Eth)(nil),            // 7: kratos.api.Data.Eth
...
var file_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.eth:type_name -> kratos.api.Data.Eth
